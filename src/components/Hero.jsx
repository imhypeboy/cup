...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-12">
      ...
      {/* Main Headline */}
      <motion.h1
        className="text-6xl md:text-8xl font-bold text-gray-900 text-center mb-6 max-w-5xl leading-tight"
      ...
      >
        React, TypeScript, 그리고 모던 웹 기술로 사용자 경험을 만들어갑니다.
      </motion.p>
      ...
      >
        <a href="https://github.com/imhypeboy" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors">
